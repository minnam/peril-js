...
var Channel = function (_Core) {
  _inherits(Channel, _Core);
  ...
  function Channel() {
    ...
    _this.pan = props.pan || 0.5;
    _this.gain = props.gain || 0.1;

    _this.input = _constant.CONTEXT.createStereoPanner();
    _this.input.pan.value = _this.pan;
